...
module Mockup =
    ...
    type MockupBrowser =
        ...
        static member Invoke(?class': string) =
            let classes = ["mockup-browser"; if class'.IsSome then class'.Value]
    ...
    type MockupBrowserToolbar =
        [<SolidComponent>]
        static member Invoke(?class': string) =
            let classes = ["mockup-browser-toolbar"; if class'.IsSome then class'.Value]
            div(class' = CssClass.combine classes)
    ...
    type MockupCode =
        [<SolidComponent>]
        static member Invoke(?class': string) =
            let classes = ["mockup-code"; if class'.IsSome then class'.Value]
            div(class' = CssClass.combine classes)
    ...
    type MockupPhone =
        [<SolidComponent>]
        static member Invoke(?class': string) =
            let classes = ["mockup-phone"; if class'.IsSome then class'.Value]
            div(class' = CssClass.combine classes)
    ...
    type MockupPhoneCamera =
        [<SolidComponent>]
        static member Invoke(?class': string) =
            let classes = ["camera"; if class'.IsSome then class'.Value]
            div(class' = CssClass.combine classes)
    ...
    type MockupPhoneDisplay =
        [<SolidComponent>]
        static member Invoke(?class': string) =
            let classes = ["display"; if class'.IsSome then class'.Value]
            div(class' = CssClass.combine classes)
    ...
    type MockupWindow =
        [<SolidComponent>]
        static member Invoke(?class': string) =
            let classes = ["mockup-window"; if class'.IsSome then class'.Value]
            div(class' = CssClass.combine classes)
